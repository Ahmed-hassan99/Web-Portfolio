        ...
        <Fade top cascade>
          <div className=" container mx-auto">
            <section className="relative flex flex-col px-8  justify-center lg:justify-start">
              <h1 className="transition-all  duration-500 inline-flex justify-center lg:justify-start  text-4xl sm:text-6xl md:text-7xl sm:pt-30 lg:text-8xl text-gray-300 font-bold nameFont leading-none lg:leading-snug  z-30">
                Ahmed
                <strong className="text-teal-500 font-bold pl-2">Hassan</strong>
              </h1>
              <h2 className="transition-all  duration-500 inline-flex justify-center text-center md:text-left lg:justify-start p-1 text-lg bg-gray-900 bg-opacity-30  md:text-xl sm:pt-30 lg:text-2xl text-gray-200  opacity-75 leading-none lg:leading-snug mt-4 z-30">
